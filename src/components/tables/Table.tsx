          ...
          <tr className="tw3-h-[45px] tw3-text-xs tw3-text-slate-500">
            {titles.map((itemTitle, i) => {
              return itemTitle.width === 'none' ? (
                <td key={i}>
                  <div
                    className={` tw3-select-none ${i === 0 ? 'tw3-mr-4' : ''}`}
                  >
                    <p>{itemTitle.title}</p>
                  </div>
                </td>
                ...
                <td key={i} style={{ minWidth: itemTitle.width }}>
                  ...
                  >
                    ...
                    <img
                      className={`tw3-ml-2 ${
                        filtered === itemTitle.title ? 'tw3-rotate-180' : ''
                      }`}
                      src={arrow}
                      alt="arrow"
                    />
            ...
            ({ task, date, category, createBy, responsible, type }, i) => {
              return (
                <tr key={i} className="tw3-h-[55px] tw3-border-y">
                  ...
                  <td>
                    <div
                      className={`tw3-inline-block tw3-py-1 tw3-px-4 tw3-rounded-2xl ${
                        category === 'Atlikti paskaičiavimą'
                          ? 'tw3-bg-teal-50'
                          : 'tw3-bg-sky-50'
                      }`}
                    >
                  ...
                  <td>
                    <a className="tw3-select-none" href="/">
