  ...
  return (
    <Dropzone onDrop={(item) => onChangeFile(item)}>
      {({ getRootProps, getInputProps }) => (
        <section className="tw3-py-5 tw3-px-3 tw3-rounded-md tw3-border-2 tw3-border-slate-300">
          <div
          ...
          <div
            className="tw3-p-2 tw3-mx-auto tw3-max-w-[260px] tw3-text-center tw3-border-2 tw3-border-dotted tw3-outline-none tw3-cursor-pointer tw3-select-none"
            {...getRootProps()}
          >
            <input className="tw3-outline-none" {...getInputProps()} />
            <p className="tw3-text-sm tw3-text-slate-400">
